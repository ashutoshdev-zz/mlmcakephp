            ...
            <div class="col-md-4">
                <?php echo $this->Form->create('User',array('id'=>'tab','type'=>'file')); ?>
                    <div class="form-group">
                        ...
                        <input type="email" name="data[User][email]" value="<?php echo $email['User']['email'];?>" class="form-control">
                    </div>
                  <div class="form-group">
                        <!--<label>Description</label>-->
                        <?php echo $this->Form->input('subject', array('type' => 'text','class'=>'form-control'));?>
                    </div>
                    <div class="form-group">
                        <!--<label>Description</label>-->
