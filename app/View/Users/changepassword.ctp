        ...
        <div class="edit">
            ...
            <div class="col-sm-6">
                <div class="edit_box">
                    ...
                    <input type="password" name="data[User][old_password]" value="" type="text"/>

                    <label>New Password</label>
                    <input type="password" name="data[User][new_password]" id="pass1" value="" type="text"/>
                    <label>Confirm Password</label>
                    <input type="password" name="data[User][cpassword]" value="" type="text"/>
                </div>
