        ...
        <div class="edit">
            ...
            <div class="col-sm-6">
                <div class="edit_box">
                    ...
                    <input name="data[User][fname]" value="<?php echo $data['User']['fname']; ?>" type="text"/>

                    <label>Last Name</label>
                    <input name="data[User][lname]" value="<?php echo $data['User']['lname']; ?>" type="text"/>
                    <label>E-mail</label>
                    <input name="data[User][email]" value="<?php echo $data['User']['email']; ?>" type="text"/>
                    <label>Address</label>
                    <input name="data[User][address]" value="<?php echo $data['User']['address']; ?>" type="text"/>
                    <label>Phone</label>
                    <input name="data[User][phone_no]" value="<?php echo $data['User']['phone_no']; ?>" type="text"/>
                    <input  value="<?php echo $data['User']['id']; ?>"  name="data[User][id]" id="userid" type="hidden"/>

                    <div class="country_res">
                        <label> Country of Residence </label>
                        <select data-content="" class="form-value"  name="data[User][cor]" data-label="Currency" data-groupid="9-desktop" tabindex="910">
                            <?php
                            $country = $data['User']['cor'];
