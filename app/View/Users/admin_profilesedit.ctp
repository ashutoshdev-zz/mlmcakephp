            ...
            <div class="col-md-4">
                <?php echo $this->Form->create('User',array('id'=>'tab')); ?>
					...
					<div class="form-group">  
                        ...
                        <?php echo $this->Form->input('susername',array('class'=>'form-control','label'=>"",'div'=>false));?>                        
                    </div>
                    <div class="form-group">
                        <?php echo $this->Form->input('email',array('class'=>'form-control'));?>      
                    </div>
					<div class="form-group">                        
                        <?php echo $this->Form->input('cor',array('class'=>'form-control'));?>                        
                    </div>
					<div class="form-group">   
						<label>Customer Membership Type</label><br>
                        <?php echo $this->Form->input('cmt',array('class'=>'form-control','label'=>"",'div'=>false));?>                        
                    </div>
					<div class="form-group"> 
						<label>Customer Membership Type</label><br>
                        <?php echo $this->Form->input('cml',array('class'=>'form-control','label'=>"",'div'=>false));?>                        
                    </div>	
					<div class="form-group">                        
