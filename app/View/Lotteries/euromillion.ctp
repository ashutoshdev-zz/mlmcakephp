                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="my_account">
                            <h2>EuroMillions(France)+STARS</h2>
<!--                            <p>Apply  Official Tickets for EuroMillions(France) Lottery Online</p>
                    ...
                    echo $this->Form->input('euromillion', array('type'=>'hidden','id'=>'erom'));
                    echo $this->Form->input('europb', array('type'=>'hidden','id'=>'eropb'));
                                            ...
                                            me.init = function() {
                                                ...
                                                $("#myTable li").off('click').on('click', function() {
                                                    ...
                                                    $("#result").html("Your Lucky No: " + m.selectedOne.toString());
                                                     $("#erom").val(m.selectedOne.toString());
                                                    m.colorize();
                                                });
                                            }
                                            me.init();
                                     ...
                                     var BlockVMA =function(){
                                            ...
                                            me.init = function() {
                                                ...
                                                $("#myTable1 li").off('click').on('click', function() {
                                                    ...
                                                    $("#eropb").val(m.selectedOne.toString());
                                                    m.colorize();
                                                });
                                            }
                                            me.init();
