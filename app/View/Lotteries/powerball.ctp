                ...
                <div class="row">
                    <div class="col-sm-8">
                        <div class="my_account">
                            <h2>U.S. Powerball+PB</h2>
<!--                            <p>Apply  Official Tickets for U.S. Powerball Lottery Online</p>
                    ...
                    echo $this->Form->input('uspb', array('type'=>'hidden','id'=>'uspb'));
                    echo $this->Form->input('pb', array('type'=>'hidden','id'=>'pb'));
