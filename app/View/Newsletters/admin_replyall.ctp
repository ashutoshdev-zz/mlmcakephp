...
<!--                    <div class="form-group">
                        <label>Email</label>
                        <?php //foreach($emailall as $emailal){?>
                        <input type="email" name="data[Newsletter][email]" value="<?php //echo $emailal['Newsletter']['email'];?>" class="form-control">
                        <?php //} ?>
                    </div>-->
                    <div class="form-group">
